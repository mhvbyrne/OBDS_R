...
all_genes_df <- read_csv("../DESeq2_tutorial/CD8_vs_CD4_DE_results_lfcshrinkage_allgenes.csv")
...
all_genes_tested_df <- all_genes_df %>% drop_na(padj)
...
# all_genes_df_filtered should be 17729 NB everyone has something slightly different as long as you're in the ball park that's fine.
